...
# padding
seq_transformed = sequence.pad_sequences(seq)
seq_transformed_test = sequence.pad_sequences(seq_test, 220)
seq_transformed_validation = sequence.pad_sequences(seq_validation, 220)
